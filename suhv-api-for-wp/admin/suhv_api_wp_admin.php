        ...
        public static function display_options_page()
        {
          ...
          <div class='wrap'>
            ...
            <form method='post' action='options.php'>
              ...
              <p>Für eine ausführliche Beschreibung des Plugins besuche die <a href='http://suhv.churunihockey.ch'
                                                                               title='Swiss Unihockey API 2.0 für WordPress'>Plugin-Website</a>
                von <a href='mailto:thomas@hardegger.com' title='API Support'>Thomas Hardegger</a></p>
                <?php
                do_settings_sections(__FILE__ . "_description");
                ?>
              <p class='submit'><input name='submit' type='submit' value='Änderungen übernehmen'
